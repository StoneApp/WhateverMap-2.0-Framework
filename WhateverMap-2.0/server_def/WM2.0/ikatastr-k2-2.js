...
"boundingBox":[-20037508.34278924,-20037508.34278924,20037508.34278924,20037508.34278924]
		...
		,
		{
			...
			"address-zacatek":["http://wms.cuzk.cz/wms.asp?REQUEST=GetMap&SERVICE=wms&VERSION=1.1.1&SRS=EPSG:32633&WIDTH=256&HEIGHT=256&FORMAT=image/png&BBOX=%@,%@,%@,%@&LAYERS=KN&TRANSPARENT=TRUE", 
				"{tileLU.x}", 
				"{tileRB.y}", 
				"{tileRB.x}", 
				"{tileLU.y}"],

			"address-lepsi":["http://wms.cuzk.cz/wms.asp?REQUEST=GetMap&SERVICE=wms&VERSION=1.1.1&SRS=EPSG:32633&WIDTH=256&HEIGHT=256&FORMAT=image/png&BBOX=%@,%@,%@,%@&LAYERS=KN&TRANSPARENT=TRUE", 
				"{tileLB.x}", 
				"{tileLB.y}", 
				"{tileRU.x}", 
				"{tileRU.y}"],
			...
			"address":["http://wms.cuzk.cz/wms.asp?REQUEST=GetMap&SERVICE=wms&VERSION=1.1.1&SRS=EPSG:32633&WIDTH=256&HEIGHT=256&FORMAT=image/png&BBOX=%@,%@,%@,%@&LAYERS=KN&TRANSPARENT=TRUE", 
				"{tileLB.x}", 
				"{tileLB.y}", 
				"{tileLB.x}+abs({tileRU.x}-{tileLB.x})*0.98", 
				"{tileLB.y}+abs({tileRU.y}-{tileLB.y})*0.98"],
