...
"boundingBox":[-20037508.34278924,-20037508.34278924,20037508.34278924,20037508.34278924]
		...
		,
		{
			...
			"address-2":["http://wms.cuzk.cz/wms.asp?REQUEST=GetMap&SERVICE=wms&VERSION=1.1.1&SRS=EPSG:32633&WIDTH=256&HEIGHT=256&FORMAT=image/png&BBOX=%@,%@,%@,%@&LAYERS=KN&TRANSPARENT=TRUE", 
				"{tileLB.x}", 
				"{tileLB.y}", 
				"{tileRU.x}", 
				"{tileRU.y}"],
			...
			"address":["http://wms.cuzk.cz/wms.asp?REQUEST=GetMap&SERVICE=wms&VERSION=1.1.1&SRS=EPSG:32633&WIDTH=256&HEIGHT=256&FORMAT=image/png&BBOX=%@,%@,%@,%@&LAYERS=KN&TRANSPARENT=TRUE", 
				"{tileC.x}-abs({tileRU.x}-{tileLU.x})/2", 
				"{tileC.y}-abs({tileRU.y}-{tileRB.y})/2", 
				"{tileC.x}+abs({tileRU.x}-{tileLU.x})/2", 
				"{tileC.y}+abs({tileRU.y}-{tileRB.y})/2"],

"address-3":["http://wms.cuzk.cz/wms.asp?REQUEST=GetMap&SERVICE=wms&VERSION=1.1.1&SRS=EPSG:32633&WIDTH=256&HEIGHT=256&FORMAT=image/png&BBOX=%@,%@,%@,%@&LAYERS=KN&TRANSPARENT=TRUE", 
				"{tileC.x}", 
				"{tileC.y}", 
				"{tileC.x}", 
				"{tileC.y}"],
